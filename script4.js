...
function drawGameOver(){
    ...
    ctx.fillStyle = 'black';
    ctx.fillText('GAME OVER. uor score is '+ score,canvas.width * 0.5, canvas.height * 0.5);
    ctx.fillStyle = 'white';
    ctx.fillText('GAME OVER. uor score is '+ score,canvas.width * 0.5 + 5, canvas.height * 0.5 + 5);
